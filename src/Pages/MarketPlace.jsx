...
const MarketPlace = () => {
  return (
    <section id="MarketPlace" className="w-full bg-white py-20 px-4 sm:px-6 lg:px-8 text-center">
      {/* Section 1 */}
      <div className="py-6">
        <h2 className="text-5xl lg:text-7xl font-extrabold text-[#0F4D0F] mb-10 sm:p-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-w-7xl mx-auto px-1 lg:px-4 ">
        {/* Farmers */}
        <div className="bg-gradient-to-l from-[#008000] to-[#0F4D0F] text-white rounded-2xl p-10 sm:p-12 lg:p-14 shadow-md">
        ...
        {/* Buyers */}
        <div className="bg-gradient-to-tr from-[#0F4D0F] to-[#008000] text-white rounded-2xl p-10 sm:p-12 lg:p-14 shadow-md">
          <div className="w-60 h-14 mx-auto mb-6 bg-white text-black flex items-center justify-center rounded-full font-bold text-lg">
            <LockKeyhole size={26} />
          </div>
